...
# remove the _file generated by uno
uno_c_files = dirutils.list_files(directory, '.c')
for file in uno_c_files:
    if os.path.basename(file).startswith('_'):
        print("Removing: ", file)
        os.remove(file)
uno_files = dirutils.list_files(directory, '.uno')
for file in uno_files:
    print("Removing: ", file)
    os.remove(file)
