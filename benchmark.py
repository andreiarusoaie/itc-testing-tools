...
def all_tools():
#    return ['cppcheck', 'sparse', 'uno', 'infer', 'splint', 'flawfinder', 'clangcore', 'clangalpha', 'framac', 'cpplint', 'flintpp', 'clanalyze']
    return ['cppcheck', 'sparse', 'uno', 'infer', 'splint', 'flawfinder', 'clangcorealpha', 'framac', 'cpplint', 'flintpp', 'clanalyze']
